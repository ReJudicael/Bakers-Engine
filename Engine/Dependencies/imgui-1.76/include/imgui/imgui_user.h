...
namespace ImGui
{
    ...
    IMGUI_API bool ImageButtonUV_HelpMarker(unsigned int user_texture_id, const char* help_marker, const ImVec2& size = { 16.f, 16.f });
    IMGUI_API bool ImageButtonUV(unsigned int user_texture_id, const ImVec2& size = { 16.f, 16.f });
    IMGUI_API bool ImageButtonUVWithText_HelpMarker(unsigned int user_texture_id, const char* label, const std::string& text, const char* help_marker, const ImVec2& icon_size = { 16.f, 16.f });
